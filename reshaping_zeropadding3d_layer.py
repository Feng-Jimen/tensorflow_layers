...
from tensorflow.keras.layers import Input,ZeroPadding3D 
...
if __name__ == "__main__":
    ...
    outputs = ZeroPadding3D(padding=(25,10,20))(inputs)
    ...
    writer = cv2.VideoWriter('result_reshaping_zeropadding3d.mp4', fmt, fps, (output_width, output_height))
