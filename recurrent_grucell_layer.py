...
from tensorflow.keras.layers import Input,RNN,GRUCell
...
if __name__ == "__main__":
    ...
    outputs = RNN(GRUCell(1), return_sequences=True, return_state=True)(inputs)
    # outputs = GRU(1, return_state=True)(inputs)
    ...
    plt.legend()
    fig.savefig('result_recurrent_grucell.png')
