...
if __name__ == "__main__":
    ...
    outputs = Concatenate(axis=-1)([inputs1,inputs2])
    ...
    outputs2 = Concatenate(axis=0)([inputs1,inputs2])
    
    model2 = Model(inputs=[inputs1,inputs2],outputs=outputs2)
    
    model2.summary()

    output_array2 = model2([input_array1,input_array2])
    print(output_array2)
