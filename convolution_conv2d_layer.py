...
if __name__ == "__main__":
    ...
    outputs = Conv2D(2,3,activation='linear')(inputs)
    ...
    cv2.imwrite('result_convolution_conv2d_filter_1.jpg', filter_1)
    cv2.imwrite('result_convolution_conv2d_filter_2.jpg', filter_2)
