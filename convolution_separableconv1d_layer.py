...
from tensorflow.keras.layers import Input,SeparableConv1D
...
if __name__ == "__main__":
    ...
    outputs = SeparableConv1D(2,3,activation='linear',padding='same')(inputs)
    ...
    plt.legend()
    fig.savefig('result_convolution_separableconv1d.png')
