...
from tensorflow.keras.layers import Input,RNN,SimpleRNNCell
...
if __name__ == "__main__":
    ...
    outputs = RNN(SimpleRNNCell(1), return_sequences=True, return_state=True)(inputs)
    # outputs = SimpleRNN(1, return_state=True)(inputs)
