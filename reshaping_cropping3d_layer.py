...
from tensorflow.keras.layers import Input,Cropping3D
...
if __name__ == "__main__":
    ...
    outputs = Cropping3D(cropping=(25,10,20))(inputs)
    ...
    writer = cv2.VideoWriter('result_reshaping_cropping3d.mp4', fmt, fps, (output_width, output_height))
