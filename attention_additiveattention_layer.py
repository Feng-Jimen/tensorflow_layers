...
from tensorflow.keras.layers import Input,AdditiveAttention,Dense
...
if __name__ == "__main__":
    ...
    outputs,scores = AdditiveAttention()([query_input, value_input], return_attention_scores=True)
    ...
    plt.legend()
    fig.savefig('result_attention_additiveattention.png')
