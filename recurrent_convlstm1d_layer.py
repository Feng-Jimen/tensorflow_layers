...
from tensorflow.keras.layers import Input,ConvLSTM1D
...
if __name__ == "__main__":
    ...
    outputs = ConvLSTM1D(2,3,activation='linear',padding='same')(inputs)
    ...
    plt.legend()
    fig.savefig('result_recurrent_convlstm1d.png')
